/* PrismJS 1.30.0
https://prismjs.com/download#themes=prism&languages=python&plugins=line-numbers+highlight-keywords+remove-initial-line-feed+match-braces */
var _self =
...
(Prism.languages.python = {
	...
	"function-call": {
		// Match full calls like foo(), bar(123), baz(x, y)
